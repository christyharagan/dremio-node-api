...
\s+                                                               /* skip whitespace */
/*                                                                
[`"][@a-zA-Z_\u4e00-\u9fa5][_\- a-zA-Z0-9_\u4e00-\u9fa5\.]*[`"]       return 'IDENTIFIER'
...
intervalNumeric
  ...
  | HEX_NUMERIC { $$ = $1 }
  | STRING { $$ = $1 }
/*  | SINGLE_QUOTE NUMERIC SINGLE_QUOTE { $$ = $2 }
  | SINGLE_QUOTE EXPONENT_NUMERIC SINGLE_QUOTE { $$ = $2 }
  | SINGLE_QUOTE HEX_NUMERIC SINGLE_QUOTE { $$ = $2 } */
  ;
